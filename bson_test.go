...
func TestTimeFromObjectIDHex(t *testing.T) {
	t.Run("valid hex objectID", func(t *testing.T) {
		cases := map[string]time.Time{
			"63acfc824ffda9000ee65045": time.Date(2022, time.December, 29, 9, 33, 38, 0, time.UTC),
			"5c4b288bac1b2972d0291377": time.Date(2019, time.January, 25, 22, 17, 31, 0, time.UTC),
		}
